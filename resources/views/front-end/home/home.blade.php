                ...
                <div class="agileinfo-ads-display col-lg-9">
                    <div class="wrapper">
                                ...
                                <div class="col-md-4 product-men mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{ asset($newMobile->product_image) }}" alt="">
                                        </div>
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{route('product-details', ['id'=>$newMobile->id, 'name'=>$newMobile->product_name])}}">{{ $newMobile->product_name }}</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                                                <span class="item_price">TK. {{ $newMobile->product_price }}</span>
                                            </div>
                        ...
                        <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
                            ...
                            <div class="row">
                                @foreach($newTvs as $newTv)
                                <div class="col-md-4 product-men mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{ asset($newTv->product_image) }}" alt="">
                                        </div>
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{route('product-details', ['id'=>$newTv->id, 'name'=>$newTv->product_name])}}">{{ $newTv->product_name }}</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                                                <span class="item_price">TK. {{ $newTv->product_price }}</span>
                        ...
                        <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mt-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 product-men mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{ asset($newLaptop->product_image) }}" alt="">
                                        </div>
                                        <span class="product-new-top">New</span>
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{route('product-details', ['id'=>$newLaptop->id, 'name'=>$newLaptop->product_name])}}">{{ $newLaptop->product_name }}</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                                                <span class="item_price">TK. {{ $newLaptop->product_price }}</span>
                                            </div>
                                            <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
                                                <form action="{{route('add-to-cart')}}" method="post">
                                                    <fieldset>
